function P = visualizeQuad(S,Obs)
 ...
 %    figure('WindowState','maximized')
    ...
    for i=1:tPlotLen
        ...
        [a,b,phi,~] = error_ellipse([Posblf(1),Posblf(2),Posblf(3)]',Ps,chi);
         ...
         hold on
         elpss_plt = plot3(r_ellipse(:,1) + Posblf(1)  , r_ellipse(:,2) + Posblf(2), zeros(length(r_ellipse)) ,'k-','LineWidth',1);
         npctpt = plot3(Posblf(1),Posblf(2),Posblf(3),'ko','MarkerSize',3,'MarkerFaceColor','k');
