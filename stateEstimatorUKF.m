function [E] = stateEstimatorUKF(S,M,P,make_meas)
...
% edited: Pete Lealiiee Jr 
%+==============================================================================+  

%----- Setup
persistent xBark PBark RBIBark
RIG = Recef2enu(P.sensorParams.r0G);
rbB = P.sensorParams.rA(:,2) - P.sensorParams.rA(:,1); rbBu = rbB/norm(rbB);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%***************************************
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%***************************************
% SECTION WHICH WAS EDITTED TO SUPPORT EVENT BASED SENSING
