...
x_im_homog = P.sensorParams.K * [RCI , t] * X;

xc = [  x_im_homog(1)/x_im_homog(3) ; x_im_homog(2)/x_im_homog(3) ];

wc = mvnrnd(zeros(2,1), P.sensorParams.Rc)';

rx = (xc/P.sensorParams.pixelSize) + wc;

if x_im_homog(3) < P.sensorParams.f || ...
        abs(xc(1)) > P.sensorParams.imagePlaneSize(1)/2 || ...
